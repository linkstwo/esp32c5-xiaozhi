...
void ui_Weather_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Pary_Cloud, 7);
    lv_obj_set_y(ui_Pary_Cloud, -87);
    lv_obj_set_align(ui_Pary_Cloud, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Pary_Cloud, "Board sensors");
    ...
    lv_obj_set_x(ui_Celsius, 3);
    lv_obj_set_y(ui_Celsius, 128);
    ...
    lv_obj_set_width(ui_Weather_Icons, lv_pct(93));
    lv_obj_set_x(ui_Weather_Icons, 1);
    lv_obj_set_y(ui_Weather_Icons, -113);
    ...
    lv_label_set_text(ui_W1_Num, "T -- C");
    ...
    lv_label_set_text(ui_W2_Num, "P -- hPa");
