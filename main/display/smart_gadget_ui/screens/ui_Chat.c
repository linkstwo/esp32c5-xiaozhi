...
void ui_Chat_screen_init(void)
{
    ...
    lv_obj_set_style_pad_top(ui_Chat_container, 17, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_Chat_container, 28, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(ui_Chat_container, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_flag(ui_C1, LV_OBJ_FLAG_GESTURE_BUBBLE);
    ...
    lv_obj_set_width(ui_Chat_Panel1, 196);
    lv_obj_set_height(ui_Chat_Panel1, LV_SIZE_CONTENT);
    lv_obj_set_align(ui_Chat_Panel1, LV_ALIGN_TOP_LEFT);
    ...
    lv_obj_set_y(ui_Chat_Icon1, 0);
    lv_obj_set_align(ui_Chat_Icon1, LV_ALIGN_BOTTOM_LEFT);
    ...
    lv_obj_add_flag(ui_C2, LV_OBJ_FLAG_GESTURE_BUBBLE);
    ...
    lv_obj_set_width(ui_Chat_Panel2, 196);
    ...
    lv_obj_set_y(ui_Delifered, 0);
    lv_obj_set_align(ui_Delifered, LV_ALIGN_BOTTOM_RIGHT);
