...
void ui_Music_Player_screen_init(void)
{
    ...
    lv_obj_set_style_shadow_opa(ui_Play_btn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_Play_btn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_opa(ui_Album, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_Album, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
