...
void ui_Clock_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Clock_Panel, 154);
    lv_obj_set_height(ui_Clock_Panel, 147);
    lv_obj_set_x(ui_Clock_Panel, 6);
    lv_obj_set_y(ui_Clock_Panel, 19);
    ...
    lv_obj_set_x(ui_Clock_Number, 1);
    lv_obj_set_y(ui_Clock_Number, -1);
