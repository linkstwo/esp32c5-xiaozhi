...
void ui_Call_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Call_Incon1, -71);
    lv_obj_set_y(ui_Call_Incon1, -19);
    ...
    lv_obj_set_style_shadow_opa(ui_Call_Incon1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_Call_Incon1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Call_Incon2, 80);
    lv_obj_set_y(ui_Call_Incon2, -23);
    ...
    lv_obj_set_style_shadow_opa(ui_Call_Incon2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_Call_Incon2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Phone2, 1);
    lv_obj_set_y(ui_Phone2, 2);
    ...
    lv_obj_set_x(ui_Avatar, 12);
    lv_obj_set_y(ui_Avatar, 4);
    ...
    lv_obj_set_style_shadow_opa(ui_Avatar, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_Avatar, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
