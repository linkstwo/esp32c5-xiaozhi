...
LcdDisplay::~LcdDisplay() {
    ...
    if (call_controls_ != nullptr) {
        lv_obj_del(call_controls_);
    }
...
void LcdDisplay::SetupUI() {
    ...
    auto screen = lv_screen_active();
    lv_obj_set_style_text_font(screen, text_font, 0);
    lv_obj_set_style_text_color(screen, lv_color_hex(0x000746), 0);
    lv_obj_set_style_bg_color(screen, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_border_color(container_, lv_color_hex(0xFFFFFF), 0);
    lv_obj_clear_flag(container_, LV_OBJ_FLAG_SCROLLABLE);

    // Subtle dotted background, approximating the tiled pattern from text_demo.
    for (int y = 18; y < LV_VER_RES - 18; y += 28) {
        for (int x = 16; x < LV_HOR_RES - 8; x += 34) {
            lv_obj_t* dot = lv_obj_create(container_);
            lv_obj_set_size(dot, 2, 2);
            lv_obj_set_pos(dot, x, y);
            lv_obj_set_style_radius(dot, 1, 0);
            lv_obj_set_style_bg_color(dot, lv_color_hex(0xECECF8), 0);
    ...
    /* Avatar layer - styled after text_demo call screen */
    emoji_box_ = lv_obj_create(screen);
    call_avatar_ = emoji_box_;
    lv_obj_set_size(emoji_box_, 62, 62);
    lv_obj_set_style_radius(emoji_box_, 31, 0);
    lv_obj_set_style_bg_color(emoji_box_, lv_color_hex(0xF8F7FF), 0);
    lv_obj_set_style_bg_opa(emoji_box_, LV_OPA_COVER, 0);
    lv_obj_set_style_pad_all(emoji_box_, 0, 0);
    lv_obj_set_style_border_width(emoji_box_, 0, 0);
    lv_obj_set_style_shadow_color(emoji_box_, lv_color_hex(0xD5D2D5), 0);
    lv_obj_set_style_shadow_opa(emoji_box_, LV_OPA_COVER, 0);
    lv_obj_set_style_shadow_width(emoji_box_, 24, 0);
    lv_obj_set_style_shadow_offset_x(emoji_box_, 3, 0);
    lv_obj_set_style_shadow_offset_y(emoji_box_, 6, 0);
    lv_obj_clear_flag(emoji_box_, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_align(emoji_box_, LV_ALIGN_TOP_MID, 0, 26);

    emoji_label_ = lv_label_create(emoji_box_);
    lv_obj_set_style_text_font(emoji_label_, large_icon_font, 0);
    lv_obj_set_style_text_color(emoji_label_, lv_color_hex(0x293062), 0);
    lv_label_set_text(emoji_label_, FONT_AWESOME_MICROCHIP_AI);
    lv_obj_center(emoji_label_);
    ...
    lv_label_set_text(network_label_, "");
    lv_obj_set_style_text_font(network_label_, icon_font, 0);
    lv_obj_set_style_text_color(network_label_, lv_color_hex(0x293062), 0);
    ...
    lv_label_set_text(mute_label_, "");
    lv_obj_set_style_text_font(mute_label_, icon_font, 0);
    lv_obj_set_style_text_color(mute_label_, lv_color_hex(0x293062), 0);

    battery_label_ = lv_label_create(right_icons);
    lv_label_set_text(battery_label_, "");
    lv_obj_set_style_text_font(battery_label_, icon_font, 0);
    lv_obj_set_style_text_color(battery_label_, lv_color_hex(0x293062), 0);
    lv_obj_set_style_margin_left(battery_label_, lvgl_theme->spacing(2), 0);
    ...
    lv_obj_set_style_text_align(notification_label_, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_color(notification_label_, lv_color_hex(0x293062), 0);
    lv_label_set_text(notification_label_, "");
    lv_obj_align(notification_label_, LV_ALIGN_CENTER, 0, 0);
    lv_obj_add_flag(notification_label_, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_label_set_long_mode(status_label_, LV_LABEL_LONG_SCROLL_CIRCULAR);
    lv_obj_set_style_text_align(status_label_, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_color(status_label_, lv_color_hex(0x9C9CD9), 0);
    lv_label_set_text(status_label_, Lang::Strings::INITIALIZING);
    lv_obj_align(status_label_, LV_ALIGN_CENTER, 0, 0);

    call_title_label_ = lv_label_create(screen);
    lv_obj_set_width(call_title_label_, LV_HOR_RES - 32);
    lv_label_set_long_mode(call_title_label_, LV_LABEL_LONG_DOT);
    lv_obj_set_style_text_font(call_title_label_, text_font, 0);
    lv_obj_set_style_text_align(call_title_label_, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_color(call_title_label_, lv_color_hex(0x000746), 0);
    lv_label_set_text(call_title_label_, "XiaoZhi AI");
    lv_obj_align(call_title_label_, LV_ALIGN_TOP_MID, 0, 98);

    call_state_label_ = lv_label_create(screen);
    lv_obj_set_width(call_state_label_, LV_HOR_RES - 36);
    lv_label_set_long_mode(call_state_label_, LV_LABEL_LONG_SCROLL_CIRCULAR);
    lv_obj_set_style_text_font(call_state_label_, text_font, 0);
    lv_obj_set_style_text_align(call_state_label_, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_color(call_state_label_, lv_color_hex(0x9C9CD9), 0);
    lv_label_set_text(call_state_label_, "Incoming Call");
    lv_obj_align(call_state_label_, LV_ALIGN_TOP_MID, 0, 122);

    chat_header_label_ = lv_label_create(screen);
    lv_obj_set_width(chat_header_label_, LV_HOR_RES - 32);
    lv_label_set_long_mode(chat_header_label_, LV_LABEL_LONG_DOT);
    lv_obj_set_style_text_font(chat_header_label_, text_font, 0);
    lv_obj_set_style_text_align(chat_header_label_, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_color(chat_header_label_, lv_color_hex(0x000746), 0);
    lv_label_set_text(chat_header_label_, "XiaoZhi Chat");
    lv_obj_align(chat_header_label_, LV_ALIGN_TOP_MID, 0, 18);
    lv_obj_add_flag(chat_header_label_, LV_OBJ_FLAG_HIDDEN);

    chat_area_ = lv_obj_create(screen);
    lv_obj_set_size(chat_area_, LV_HOR_RES, 154);
    lv_obj_align(chat_area_, LV_ALIGN_TOP_MID, 0, 50);
    lv_obj_set_style_bg_opa(chat_area_, LV_OPA_TRANSP, 0);
    lv_obj_set_style_border_width(chat_area_, 0, 0);
    lv_obj_set_style_pad_all(chat_area_, 0, 0);
    lv_obj_set_scrollbar_mode(chat_area_, LV_SCROLLBAR_MODE_OFF);
    lv_obj_clear_flag(chat_area_, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_add_flag(chat_area_, LV_OBJ_FLAG_HIDDEN);

    auto create_chat_bubble = [text_font](lv_obj_t* parent, lv_color_t color, lv_align_t align, int x_ofs, int y_ofs) {
        lv_obj_t* bubble = lv_obj_create(parent);
        lv_obj_set_size(bubble, 172, 64);
        lv_obj_set_style_radius(bubble, 12, 0);
        lv_obj_set_style_bg_color(bubble, color, 0);
    ...
    assistant_bubble_ = create_chat_bubble(chat_area_, lv_color_hex(0x9C9CD9), LV_ALIGN_TOP_LEFT, 12, 0);
    assistant_bubble_label_ = lv_obj_get_child(assistant_bubble_, 0);
    lv_obj_add_flag(assistant_bubble_, LV_OBJ_FLAG_HIDDEN);

    user_bubble_ = create_chat_bubble(chat_area_, lv_color_hex(0x293062), LV_ALIGN_BOTTOM_RIGHT, -12, 0);
    user_bubble_label_ = lv_obj_get_child(user_bubble_, 0);
    lv_obj_add_flag(user_bubble_, LV_OBJ_FLAG_HIDDEN);
    ...
    call_controls_ = lv_obj_create(screen);
    lv_obj_set_size(call_controls_, LV_HOR_RES, 68);
    lv_obj_set_style_bg_opa(call_controls_, LV_OPA_TRANSP, 0);
    lv_obj_set_style_border_width(call_controls_, 0, 0);
    lv_obj_set_style_pad_all(call_controls_, 0, 0);
    lv_obj_set_scrollbar_mode(call_controls_, LV_SCROLLBAR_MODE_OFF);
    lv_obj_align(call_controls_, LV_ALIGN_BOTTOM_MID, 0, -8);

    auto create_call_button = [large_icon_font](lv_obj_t* parent, int x_ofs,
            lv_color_t bg_color, const char* icon) {
        lv_obj_t* button = lv_obj_create(parent);
        lv_obj_set_size(button, 60, 60);
        lv_obj_set_style_radius(button, 60, 0);
        lv_obj_set_style_bg_color(button, bg_color, 0);
        lv_obj_set_style_bg_opa(button, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(button, 0, 0);
        lv_obj_set_style_shadow_color(button, bg_color, 0);
        lv_obj_set_style_shadow_opa(button, 150, 0);
        lv_obj_set_style_shadow_width(button, 30, 0);
        lv_obj_set_style_shadow_offset_x(button, 3, 0);
        lv_obj_set_style_shadow_offset_y(button, 6, 0);
        lv_obj_clear_flag(button, LV_OBJ_FLAG_SCROLLABLE);
        lv_obj_clear_flag(button, LV_OBJ_FLAG_CLICKABLE);
        lv_obj_align(button, LV_ALIGN_BOTTOM_MID, x_ofs, -8);
    ...
    create_call_button(call_controls_, -68, lv_color_hex(0xE63431), FONT_AWESOME_XMARK);
    create_call_button(call_controls_, 68, lv_color_hex(0x10D262), FONT_AWESOME_PHONE);
...
void LcdDisplay::SetStatus(const char* status) {
    ...
    if (call_state_label_ != nullptr && (chat_area_ == nullptr || lv_obj_has_flag(chat_area_, LV_OBJ_FLAG_HIDDEN))) {
        lv_label_set_text(call_state_label_, text);
    }

    last_status_update_time_ = std::chrono::system_clock::now();
}

void LcdDisplay::ShowCallPage() {
    DisplayLockGuard lock(this);
    chat_page_active_ = false;

    if (call_avatar_ != nullptr) {
        lv_obj_remove_flag(call_avatar_, LV_OBJ_FLAG_HIDDEN);
    }
    if (call_title_label_ != nullptr) {
        lv_obj_remove_flag(call_title_label_, LV_OBJ_FLAG_HIDDEN);
    }
    if (call_state_label_ != nullptr) {
        lv_obj_remove_flag(call_state_label_, LV_OBJ_FLAG_HIDDEN);
    }
    if (call_controls_ != nullptr) {
        lv_obj_remove_flag(call_controls_, LV_OBJ_FLAG_HIDDEN);
    }
    if (chat_header_label_ != nullptr) {
        lv_obj_add_flag(chat_header_label_, LV_OBJ_FLAG_HIDDEN);
    }
    if (chat_area_ != nullptr) {
        lv_obj_add_flag(chat_area_, LV_OBJ_FLAG_HIDDEN);
    }
}

void LcdDisplay::ShowChatPage() {
    DisplayLockGuard lock(this);
    chat_page_active_ = true;

    if (call_avatar_ != nullptr) {
        lv_obj_add_flag(call_avatar_, LV_OBJ_FLAG_HIDDEN);
    }
    if (call_title_label_ != nullptr) {
        lv_obj_add_flag(call_title_label_, LV_OBJ_FLAG_HIDDEN);
    }
    if (call_state_label_ != nullptr) {
        lv_obj_add_flag(call_state_label_, LV_OBJ_FLAG_HIDDEN);
    }
    if (call_controls_ != nullptr) {
        lv_obj_add_flag(call_controls_, LV_OBJ_FLAG_HIDDEN);
    }
    if (chat_header_label_ != nullptr) {
        lv_obj_remove_flag(chat_header_label_, LV_OBJ_FLAG_HIDDEN);
    }
    if (chat_area_ != nullptr) {
        lv_obj_remove_flag(chat_area_, LV_OBJ_FLAG_HIDDEN);
    }
}
...
void LcdDisplay::SetChatMessage(const char* role, const char* content) {
    ...
    // The text_demo style uses chat bubbles, so keep the old subtitle strip hidden.
    if (bottom_bar_ != nullptr) {
    ...
    if (strcmp(safe_role, "user") == 0) {
        if (user_bubble_label_ != nullptr && user_bubble_ != nullptr) {
            lv_label_set_text(user_bubble_label_, safe_content);
            lv_obj_remove_flag(user_bubble_, LV_OBJ_FLAG_HIDDEN);
        }
    } else if (strcmp(safe_role, "assistant") == 0) {
        if (assistant_bubble_label_ != nullptr && assistant_bubble_ != nullptr) {
            lv_label_set_text(assistant_bubble_label_, safe_content);
            lv_obj_remove_flag(assistant_bubble_, LV_OBJ_FLAG_HIDDEN);
        }
    } else {
        if (call_state_label_ != nullptr) {
            lv_label_set_text(call_state_label_, safe_content);
        }
        return;
    }

    if (chat_page_active_) {
        if (chat_header_label_ != nullptr) {
            lv_obj_remove_flag(chat_header_label_, LV_OBJ_FLAG_HIDDEN);
        }
        if (chat_area_ != nullptr) {
...
void LcdDisplay::ClearChatMessages() {
    ...
    if (assistant_bubble_label_ != nullptr) {
        lv_label_set_text(assistant_bubble_label_, "");
    }
    if (user_bubble_label_ != nullptr) {
        lv_label_set_text(user_bubble_label_, "");
    }
    if (assistant_bubble_ != nullptr) {
        lv_obj_add_flag(assistant_bubble_, LV_OBJ_FLAG_HIDDEN);
    }
    if (user_bubble_ != nullptr) {
        lv_obj_add_flag(user_bubble_, LV_OBJ_FLAG_HIDDEN);
    }
    chat_page_active_ = false;
    if (chat_header_label_ != nullptr) {
