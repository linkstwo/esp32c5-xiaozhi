...
The ESP32-C3-LCDkit development framework is `ESP-IDF <https://github.com/espressif/esp-idf>`_. ESP-IDF is a FreeRTOS-based SoC development framework with a bunch of components including LCD, ADC, RMT, and SPI. An example is provided for ESP32-C3-LCDkit under the folder :project:`Examples <examples/esp32-c3-lcdkit>`. You can configure project options by entering ``idf.py menuconfig`` in the example directory.


Application Examples
--------------------

The following application examples are available for ESP32-C3-LCDkit:
...
-  `ESP32-C3-LCDkit_MB Schematics`_
-  `ESP32-C3-LCDkit_MB PCB Layout`_
-  `ESP32-C3-LCDkit_DB Schematics`_
-  `ESP32-C3-LCDkit_DB PCB Layout`_
-  `ESP32-C6-LCDkit_DB Schematics`_
-  `ESP32-C6-LCDkit_DB PCB Layout`_
-  `1.28_TFT_240x240_SPI_Display`_
-  `Infrared Transmitter (IR67-21CTR8)`_
-  `Infrared Receiver（IRM-H638TTR2）`_
-  `Audio Amplifier (NS4150)`_
-  `RGB LED (WS2812B)`_
-  `2415 Voice Cavity Horn`_

For further design documentation for the board, please contact us at `sales@espressif.com <sales@espressif.com>`_.

.. _ESP32-C3-LCDkit_MB Schematics: https://dl.espressif.com/dl/schematics/SCH_ESP32-C3-C6-LCDkit-MB_V1.1_20230417.pdf
.. _ESP32-C3-LCDkit_MB PCB Layout: https://dl.espressif.com/dl/schematics/PCB_ESP32-C3-C6-LCDkit-MB_V1.1_20230418.pdf
.. _ESP32-C3-LCDkit_DB Schematics: https://dl.espressif.com/dl/schematics/SCH_ESP32-C3-LCDkit-DB_V1.0_20230329.pdf
.. _ESP32-C3-LCDkit_DB PCB Layout: https://dl.espressif.com/dl/schematics/PCB_ESP32-C3-LCDkit-DB_V1.0_20230329.pdf
.. _ESP32-C6-LCDkit_DB Schematics: https://dl.espressif.com/dl/schematics/SCH_ESP32-C6-LCDkit-DB_V1.0_20230403.pdf
.. _ESP32-C6-LCDkit_DB PCB Layout: https://dl.espressif.com/dl/schematics/PCB_ESP32-C6-LCDkit-DB_V1.0_20230403.pdf
.. _1.28_TFT_240x240_SPI_Display: https://dl.espressif.com/dl/schematics/1.28_TFT_240x240_SPI_屏.pdf
.. _Infrared Transmitter (IR67-21CTR8): https://dl.espressif.com/dl/schematics/EVERLIGHT(亿光)_IR67-21CTR8.PDF
.. _Infrared Receiver（IRM-H638TTR2）: https://dl.espressif.com/dl/schematics/EVERLIGHT(亿光)_IRM-H638TTR2.PDF
.. _Audio Amplifier (NS4150): https://dl.espressif.com/dl/schematics/NS4150B.pdf
.. _RGB LED (WS2812B): https://dl.espressif.com/dl/schematics/WS2812B-Mini-V3.pdf
.. _2415 Voice Cavity Horn: https://dl.espressif.com/dl/schematics/方形2415音腔喇叭规格书-2P1.25-20MM.pdf
