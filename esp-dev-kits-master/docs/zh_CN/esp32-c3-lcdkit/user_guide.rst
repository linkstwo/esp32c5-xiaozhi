...
ESP32-C3-LCDkit 的开发框架为 `ESP-IDF <https://github.com/espressif/esp-idf>`_。ESP-IDF 是基于 FreeRTOS 的乐鑫 SoC 开发框架，具有众多组件，包括 LCD、ADC、RMT、SPI 等。开发板应用示例存放在 :project:`Examples <examples/esp32-c3-lcdkit>` 中，在示例目录下输入 ``idf.py menuconfig`` 可以配置工程选项。
...
-  `ESP32-C3-LCDkit_MB 原理图`_
-  `ESP32-C3-LCDkit_MB PCB 布局图`_
-  `ESP32-C3-LCDkit_DB 原理图`_
-  `ESP32-C3-LCDkit_DB PCB 布局图`_
-  `ESP32-C6-LCDkit_DB 原理图`_
-  `ESP32-C6-LCDkit_DB PCB 布局图`_
-  `1.28_TFT_240x240_SPI_屏`_
-  `红外发射器（IR67-21CTR8）`_
-  `红外接收器（IRM-H638TTR2）`_
-  `音频功放（NS4150）`_
-  `RGB LED（WS2812B）`_
-  `2415 音腔喇叭`_
