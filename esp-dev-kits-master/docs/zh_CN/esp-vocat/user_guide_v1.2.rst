...
ESP-VoCat 主控采用乐鑫 ESP32-S3-WROOM-1-N16R16VA 模组，支持 2.4 GHz Wi-Fi 和 Bluetooth 5 (LE) 无线连接。存储方面，整机具备 16 MB PSRAM、16 MB flash 的存储空间，同时还配备了一个可支持高达 32GB 的 microSD 卡插槽，满足语音交互和多媒体处理需求。配备 1.85 英寸圆形触摸屏（360 × 360 分辨率）与 ESP32-S3 原生触摸传感器，提供直观丰富的交互体验。

音频方面，ESP-VoCat 内置 3W 扬声器和双麦克风阵列，支持本地语音唤醒和声源定位。电源系统兼容 5 V DC 和 3.7 V 锂电池供电。此外，还集成一个 USB-C 接口支持供电与编程下载，同时预留 Pogopin 接口方便功能扩展。

.. figure:: ../../_static/esp-vocat/esp-vocat-black-front_v1.0.png
   :alt: ESP-VoCat 正面图（点击放大）
   :scale: 18%
...
.. figure:: ../../_static/esp-vocat/esp-vocat-coreboard-front-annotated-photo_v1.2.png
   :alt: ESP-VoCat CoreBoard PCB 正面图（点击放大）
   :scale: 70%
   :figclass: align-center

   ESP-VoCat CoreBoard PCB 正面图（点击放大）

.. figure:: ../../_static/esp-vocat/esp-vocat-micboard-front-annotated-photo_v1.2.png
   :alt: ESP-VoCat MicBoard PCB 正面图（点击放大）
   :scale: 70%
   :figclass: align-center

   ESP-VoCat MicBoard PCB 正面图（点击放大）

.. figure:: ../../_static/esp-vocat/esp-vocat-baseboard-front-annotated-photo_v1.2.png
   :alt: ESP-VoCat BaseBoard PCB 正面图（点击放大）
   :scale: 70%
   :figclass: align-center

   ESP-VoCat BaseBoard PCB 正面图（点击放大）
...
以下按照顺时针的顺序依次介绍正面 PCB 上的主要组件。为了方便用户使用，我们同时在 ESP-VoCat 的外壳上标注出了这些组件或者接口。
...
.. figure:: ../../_static/esp-vocat/esp-vocat-coreboard-back-annotated-photo_v1.2.png
   :alt: ESP-VoCat CoreBoard PCB 背面图（点击放大）
   :scale: 70%
   :figclass: align-center

   ESP-VoCat CoreBoard PCB 背面图（点击放大）

.. figure:: ../../_static/esp-vocat/esp-vocat-micboard-back-annotated-photo_v1.2.png
   :alt: ESP-VoCat MicBoard PCB 背面图（点击放大）
   :scale: 70%
   :figclass: align-center

   ESP-VoCat MicBoard PCB 背面图（点击放大）

.. figure:: ../../_static/esp-vocat/esp-vocat-baseboard-back-annotated-photo_v1.2.png
   :alt: ESP-VoCat BaseBoard PCB 背面图（点击放大）
   :scale: 70%
   :figclass: align-center

   ESP-VoCat BaseBoard PCB 背面图（点击放大）
...
以下按照顺时针的顺序依次介绍背面 PCB 上的主要组件。为了方便用户使用，我们同时在 ESP-VoCat 的外壳上标注出了这些组件或者接口。
...
使用 USB 数据线将 ESP-VoCat 连接到电脑，通过 ``Type-C（USB-C 接口）`` 烧录固件、调试和供电。
...
ESP-VoCat 的主要组件和连接方式如下图所示。

.. figure:: ../../_static/esp-vocat/esp-vocat-sch-function-block_v1.2.png
   :alt: ESP-VoCat 功能框图（点击放大）
   :scale: 40%
   :figclass: align-center
...
2. 通过 ``Magnetic Connector（磁吸连接器）`` 供电
  ...
  .. figure:: ../../_static/esp-vocat/esp-vocat-magnetic-connector-annotated-photo_v1.2.png
   :alt: 磁吸连接器（点击放大）
   :scale: 70%
   :figclass: align-center
...
.. _Related-documents_esp-vocat_2:
